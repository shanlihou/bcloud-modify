...
class NewFolderDialog(Gtk.Dialog):
    ...
    def __init__(self, parent, app, path):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:__init__ 21')
    ...
    def on_show(self, *args):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:on_show 54')
        if len(self.path) == 1:
    ...
    def do_response(self, response_id):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:do_response 60')
        if response_id == Gtk.ResponseType.OK:
            self.mkdir()

    def on_entry_changed(self, entry):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:on_entry_changed 64')
        self.validate_path()

    def on_entry_activated(self, entry):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:on_entry_activated 67')
        self.mkdir()
        self.destroy()

    def show_message(self, message):
        def hide_message(timestamp):
            print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:hide_message 71')
    ...
    def validate_path(self):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:validate_path 81')
    ...
    def mkdir(self):
        print('/usr/local/lib/python3.4/dist-packages/bcloud/NewFolderDialog.py:mkdir 95')
