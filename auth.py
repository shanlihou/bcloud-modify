...
def get_ppui_logintime():
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_ppui_logintime 24')
    '''ppui_ligintime 这个字段, 是一个随机数.'''
    return str(random.randint(52000, 58535))

def get_BAIDUID():
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_BAIDUID 28')
    '''获取一个cookie - BAIDUID.
...
def get_UBI(cookie, tokens):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_UBI 81')
...
def check_login(cookie, tokens, username):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:check_login 103')
...
def get_signin_vcode(cookie, codeString):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_signin_vcode 131')
    '''获取登录时的验证码图片.
...
def refresh_signin_vcode(cookie, tokens, vcodetype):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:refresh_signin_vcode 151')
    '''刷新验证码.
...
def get_public_key(cookie, tokens):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_public_key 180')
    '''获取RSA公钥, 这个用于加密用户的密码
...
def post_login(cookie, tokens, username, password, rsakey, verifycode='',
               codestring=''):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:post_login 201')
    '''登录验证.
...
def parse_bdstoken(content):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:parse_bdstoken 266')
    '''从页面中解析出bdstoken等信息.
...
def get_bdstoken(cookie):
    print('/usr/local/lib/python3.4/dist-packages/bcloud/auth.py:get_bdstoken 281')
